        ...
        <div class="background-">
            <div class="page-">
                <div>
                  <H1>RSA-Encrypt</H1>
                  <!--<label>messaeg</label>-->
                  <input type="number" required placeholder="Messaeg" name="Messaeg" value="">
                </div>
                <div>
                  <!--<label>p</label>-->
                  ...
                  <!--<label>r</label>-->
                  <input class="b-" type="number" required placeholder="r" name="r" value="">
                </div>
                <div>
                  <!--<label>Equals</label>-->
                ...
                <div>
                    ...
                    <input class="a-" type="Result" placeholder="public key" name="public key" value="" readonly>
                    <!--<label>Result message Encryption</label>-->
                    <input class="a-" type="Result" placeholder="message Encryption" name="message Encryption" value="" readonly>
                </div>
            </div>
        </div>
    </div>
